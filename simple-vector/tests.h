...
inline void SetTest1() {
    std::cout << "Set of tests #1 for SimpleVector" << std::endl;
...
inline void SetTest2() {
    std::cout << "Set of tests #2 for SimpleVector" << std::endl;
